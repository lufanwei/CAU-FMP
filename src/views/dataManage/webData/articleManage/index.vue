<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <router-link :to="'/data-manage/web-data/article-manage/create'" class="link-type">
    ...
    >
      ...
      <el-table-column label="Title" min-width="150px">
        <template slot-scope="{row}">
          <router-link :to="'/data-manage/web-data/article-manage/edit/'+row.id" class="link-type">
            <span>{{ row.title }}</span>
          </router-link>
