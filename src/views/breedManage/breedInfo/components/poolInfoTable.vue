<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.title" placeholder="Title" style="width: 150px;" class="filter-item"
...
<script>
  import {fetchList, fetchPv, createArticle, updateBaseInfo} from '@/api/base-info'
